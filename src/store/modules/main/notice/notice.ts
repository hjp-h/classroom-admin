...
import { INoticeState, IPayLoadtype } from './type'
// 请求相关
import {
  getPageList,
  delPageList,
  addPageList,
  editPageList
} from '@/service/main/notice/notice'
// 工具类
import { showMessage } from '@/utils/message'
const noticeModule: Module<INoticeState, IRootState> = {
  namespaced: true,
  state() {
    return {
      noticeList: [],
